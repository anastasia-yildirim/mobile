...
public class WikipediaGetStartedTests extends TestBase {
    ...
    void successfullySkipOnboarding() {
        step("Закрыть экран онбординга Get Started с помощью кнопки Skip", () ->
                getStartedScreen.clickSkipButton());
    ...
    void successfullyGoThroughOnboarding() {
        step("Перейти на следующий экран туториала с помощью кнопки Сontinue", () ->
                getStartedScreen.clickContinueButton());
        ...
        step("Перейти на главный экран с помощью кнопки Get Started", () ->
                getStartedScreen.clickGetStartedButton());
